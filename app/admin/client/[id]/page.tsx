...
export default async function AdminClientPage({
  ...
  const [{ data: audits }, { data: scans }, { data: latestFull }] = await Promise.all([
    db
      .from("audits")
  ...
  const latestBusiness = rows[0]?.business_name ?? clientProfile.business_name ?? clientProfile.email;
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-4)" }}>
            <Link href="/admin" style={{ fontSize: "var(--text-sm)", color: "var(--carolina)", textDecoration: "none" }}>
              ← All Clients
            </Link>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
          <span style={{
          ...
          <span style={{ fontSize: "var(--text-sm)", color: "var(--muted)" }}>
            Viewing dashboard for <strong style={{ color: "var(--text)" }}>{latestBusiness}</strong>
            {clientProfile.email && (
      ...
      <main style={{
        ...
        <div style={{ marginBottom: "var(--space-8)" }}>
          <p className="label" style={{ marginBottom: "var(--space-2)" }}>Client Dashboard</p>
