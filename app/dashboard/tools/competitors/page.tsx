...
export const metadata: Metadata = {
  title: "Competitor Watch — Local Search Ally",
  description:
    "Competitive intelligence on the local businesses ranking ahead of you.",
};

export default async function CompetitorsToolPage() {
  ...
  await requireProAccess(user.id, "competitors");
      ...
      <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
        ...
        >
          ...
          <p className='text-small' style={{ marginBottom: "var(--space-6)" }}>
            Run an audit first so we know who you compete with.
          </p>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      >
        ...
        <CompetitorWatch auditId={latest.id} />
      </main>
    </div>
  );
}
