...
export const metadata: Metadata = {
  title: "Backlink Outreach — Local Search Ally",
  description:
    "Trade-specific backlink prospects and outreach email templates for local contractors.",
};

export default async function BacklinksToolPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      >
        ...
        <BacklinkOutreach auditId={latest.id} />
      </main>
    </div>
  );
}
