...
import OnPageFixer from "./OnPageFixer";

export const metadata: Metadata = {
  title: "On-Page Fixer — Local Search Ally",
  description:
    "AI-rewritten title tags, meta descriptions, and H1s for your local service pages.",
};

export default async function OnPageToolPage() {
  ...
  await requireProAccess(user.id, "onpage");
  ...
  const inputObj =
    latest.input && typeof latest.input === "object"
      ...
      : null;
  const defaultUrl = inputObj?.websiteUrl ?? null;
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      >
        ...
        <OnPageFixer auditId={latest.id} defaultUrl={defaultUrl} />
      </main>
    </div>
  );
}
