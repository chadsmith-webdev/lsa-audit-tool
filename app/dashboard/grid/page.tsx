...
export const metadata: Metadata = {
  ...
  description:
    "See where your business ranks across a local service area for any keyword.",
};
    ...
    <div className={`min-h-screen ${styles.page}`}>
      ...
      <main className={styles.main}>
        ...
        <div className={`animate-fade-up ${styles.pageHeader}`}>
          <h1 className={`heading-1 ${styles.pageHeading}`}>
            Geo-Grid Rank Tracker
          </h1>
          <p className={styles.pageLede}>
            See where your business ranks across 25 points in your service area
        ...
        <div className='animate-fade-up stagger-2'>
          <Suspense
            fallback={
              <div className={`card card-default ${styles.suspenseFallback}`}>
